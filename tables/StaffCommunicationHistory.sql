...
GO
CREATE TABLE [dbo].[StaffCommunicationHistory](
	[StaffCommunicationHistoryId] [bigint] IDENTITY(1,1) NOT NULL,
...
(
	[StaffCommunicationHistoryId] ASC
...
GO
ALTER TABLE [dbo].[StaffCommunicationHistory] ADD  DEFAULT ((1)) FOR [HasRead]
GO
